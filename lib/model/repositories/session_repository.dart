...
class SessionRepository {
  ...
  Future<bool> cacheNews(DataLocalInfo news) async {
    ...
    var list = await pref.getList(DATA_CONST.CACHE_NEWS);
  ...
  Future<bool> cacheLand(DataLocalInfo land) {
    return pref.saveString(DATA_CONST.CACHE_LANDPLANNING, land.toJson());
  }
